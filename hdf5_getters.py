"""
This file contains getter methods for retrieving data from the hdf5 files for a song.
This code was provided by the MSD creators in order to more easily read the data.
